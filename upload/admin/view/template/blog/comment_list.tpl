            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.date_modified') { ?>
                        <a href="<?php echo $sort_date_modified; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_date_modified; ?></a>
                        <?php } else { ?>
                        <a href="<?php echo $sort_date_modified; ?>"><?php echo $column_date_modified; ?></a>
                        <?php } ?></td>
                  <td class="text-center" width="50%"><?php echo $column_text; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($comment['comment_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $comment['date_modified']; ?></td>
                  ...
                  <td class="text-right"><?php if ($comment['status']) { ?>
                        <a href="<?php echo $comment['status_link']; ?>" role="button" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="<?php echo $help_enabled_button; ?>"><?php echo $text_enabled; ?></a>
                        <?php } else { ?>
                        <a href="<?php echo $comment['status_link']; ?>" role="button" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="<?php echo $help_disabled_button; ?>"><?php echo $text_disabled; ?></a>
                        <?php } ?></td>
